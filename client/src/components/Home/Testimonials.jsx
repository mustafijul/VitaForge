    ...
    <>
     <div id="Testimonials" className=' mt-16'>
      ...
      <div className="flex justify-center mb-8">
        <div className="flex items-center justify-center gap-2 text-sm text-blue-800 bg-blue-400/10 border border-indigo-200 rounded-full px-4 py-1 max-w-xl">
          <svg
            width="13"
            height="14"
            viewBox="0 0 13 14"
     ...
     <div className="flex justify-center mb-8">
        <Title
          title="Don't Just take your words"
          description="This platform transformed my job search. I landed interviews at 3 top tech companies within 2 weeks of using my new resume. The templates are modern and the guidance helped me highlight my achievements effectively."
        ></Title>
      </div>

    </div>

    {/* marque section of tesimonials */}
            <>
            <style>{`
